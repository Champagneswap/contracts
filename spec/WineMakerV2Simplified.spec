 ...
 *
 * Run this file with scripts/_runWineMakerV2Simplified.sh
 */
...
methods {
	...
	// overrided methods
	chamPerBlock() returns (uint256 amount)
	...
	// CHAM token
	CHAM() returns (address) envfree // NOT USED
	champagneToken.balanceOf(address) returns (uint256) // NOT USED
	...
	// Rewarder
	// SIG_ON_CHAM_REWARD = 0xbb6cc2ef; // onChamReward(uint256,address,uint256)
	0xbb6cc2ef => NONDET
