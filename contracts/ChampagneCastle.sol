...
// ChampagneCastle helps your migrate your existing Uniswap LP tokens to ChampagneSwap LP ones
contract ChampagneCastle {
    ...
    function migrate(
        ...
        require(deadline >= block.timestamp, 'ChampagneSwap: EXPIRED');
    ...
    function removeLiquidity(
        ...
        require(amountA >= amountAMin, 'ChampagneCastle: INSUFFICIENT_A_AMOUNT');
        require(amountB >= amountBMin, 'ChampagneCastle: INSUFFICIENT_B_AMOUNT');
    }
