...
module.exports = async function ({ getNamedAccounts, getChainId, deployments }) {
  ...
  const champagneswapRouterAddress = (await deployments.get("UniswapV2Router02")).address

  await deploy("ChampagneCastle", {
    from: deployer,
    args: [uniswapRouterAddress, champagneswapRouterAddress],
    log: true,
    deterministicDeployment: false
  })
}

module.exports.tags = ["ChampagneCastle"]
